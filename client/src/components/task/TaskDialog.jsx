...
import { useDuplicateTaskMutation, useTrashTaskMutation, useDeleteRestoreTaskMutation } from "../../redux/slices/apiSlice";
...
const TaskDialog = ({ task }) => {
  ...
  const deleteHandler = async () => {
    try {
      const res = await trashTask({ _id: task._id }).unwrap();
